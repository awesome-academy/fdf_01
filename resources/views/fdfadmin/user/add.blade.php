        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">@lang('managing_user.user')
                    <small>@lang('managing_user.user_add')</small>
                </h1>
            </div>
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @endif
                {!! Form::open(['method'=>'POST', 'route'=>'managing-user.store', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                    	{!! Form::label('email', trans('managing_user.email')) !!}
                    	{!! Form::text('email', '', ['class'=>'form-control', 'placeholder' => trans('managing_user.place_email')]) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('txtName', '', ['class'=>'form-control', 'placeholder' => trans('managing_user.place_name')]) !!}
                    </div>

                    <div class="form-group">
                    	{!! Form::label('phone_number', trans('managing_user.phone_number')) !!}
                        {!! Form::text('txtPhone', '', ['class'=>'form-control', 'placeholder' => trans('managing_user.place_phone')]) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('txtAddress', '', ['class'=>'form-control', 'placeholder' => trans('managing_user.place_address')]) !!}
                    </div>
                    ...
                    {!! Form::submit(trans('managing_user.user_add'), ['class'=>'btn btn-default']) !!}
