    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            array('name'=>'abc', 'email'=>'abc2@gmail.com', 'password'=>'$2y$10$TKh8H1.PfQx37YgCzwiKb.KjNyWgaHb9cbcoQgdIVFlYg7B77UdFm',
                'phone_number'=>'0120129192', 'role'=>0, 'gender'=>1, 'address'=>'danang', 'avatar' => 'abc.jpg', 'remember_token' => str_random(10)),
            array('name'=>'abc', 'email'=>'abc3@gmail.com', 'password'=>'$2y$10$TKh8H1.PfQx37YgCzwiKb.KjNyWgaHb9cbcoQgdIVFlYg7B77UdFm',
